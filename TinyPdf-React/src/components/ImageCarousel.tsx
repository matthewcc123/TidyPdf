        ...
        <>
            ...
            <div className="flex items-center relative w-full min-h-32 max-h-64 bg-gray-200/50 rounded-md overflow-hidden p-2 border border-gray-300/50">
                ...
                <div
                    ...
                    style={{ transform: `translateX(calc(-${currentIndex * 60}%))` }}
                >
                    {images.map((image, index) => (
                        <div
                            key={index}
                            className="shrink-0 w-[60%] p-2 flex justify-center items-center hover:scale-102 transition-transform duration-300"
